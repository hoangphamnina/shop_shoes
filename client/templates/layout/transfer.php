...
<head>
    ...
    <style type="text/css">
        ...
        @font-face {
            ...
            font-weight: normal;
            font-display: auto;
            src: url("assets/webfonts/awesome/fa-brands-400.woff2") format("woff2"), url("assets/webfonts/awesome/fa-brands-400.woff") format("woff");
        }
        ...
        @font-face {
            ...
            font-weight: 400;
            font-display: auto;
            src: url("assets/webfonts/awesome/fa-regular-400.woff2") format("woff2"), url("assets/webfonts/awesome/fa-regular-400.woff") format("woff");
        }
        ...
        @font-face {
            ...
            font-weight: 900;
            font-display: auto;
            src: url("assets/webfonts/awesome/fa-solid-900.woff2") format("woff2"), url("assets/webfonts/awesome/fa-solid-900.woff") format("woff");
        }
